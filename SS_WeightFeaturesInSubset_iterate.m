function errors = SS_WeightFeaturesInSubset_iterate
...
errors = zeros(numel(sortedFeatureNames),1);
for numFeatures = 1:numel(sortedFeatureNames)
    
    wantedFeatureNames = sortedFeatureNames(1:numFeatures);
    ...
    errors(numFeatures) = err;
end

figure
plot(1:numel(sortedFeatureNames), errors, 'LineWidth', 2)
xlabel('num features')
